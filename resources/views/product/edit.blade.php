...
<div class="container-fluid">
    ...
    <div class="row px-5">
        ...
        <div class="card shadow mt-3 col-lg-12 col-md-12 col-sm-12">
            ...
            <div class="d-flex justify-content-center gt-0">
                <img src="{{ asset('uploads/'.$product->image) }}" class="img-thumbnail rounded" width="150px" height="50px">
                ...
                <form action="{{ route('admin.product.update',$product->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="form-group col-lg-6 col-md-6 col-sm-12">
                            ...
                            <input type="text" name="productName" value="{{ old('productName',$product->name) }}" class="form-control" id="productName">
                    ...
                    <div class="row pt-3">
                        <div class="form-group col-lg-6 col-md-6 col-sm-12">
                            ...
                            <select name="color" class="form-control">
                                <option value="{{$product->id }}"> {{  $product->Color->name }} </option>
                        ...
                        <div class="form-group col-lg-6 col-md-6 col-sm-12">
                            ...
                            <select name="size" class="form-control">
                                <option value="{{ $product->id }}">{{ $product->Size->name }}</option>
                    ...
                    <div class="row pt-3">
                        ...
                        <div class="form-group col-lg-6 col-md-6 col-sm-12">
                            ...
                            <input type="text" name="qty" value="{{ old('qty',$product->qty) }}" class="form-control" id="qty">
                              @if($errors->has('qty'))
                    ...
                    <div class="row pt-2">
                        <div class="form-group offset-9 col-lg-3 col-md-6 col-sm-12">
                        <button type="submit" class="btn btn-sm btn-secondary my-3 fw-bolder px-3">Update</button>
