    ...
    <div class="row" id="row1" >
        ...
        <div class="card mt-3 col-lg-12 col-md-12 col-sm-12 class3 px-5" id="card1">
            <div class="card-header text-center fs1 bolder">
                ...
                <h2 class="font-bolder">Category List</h2>
                <div class="py-3">
                    <h3 class="card-title float-start "><a href="{{ route('admin.category.create') }}">
               ...
               ">
                <table class="g-0 table table-responsive table-bordered table-striped table-hover">
                    ...
                    <tbody>
                     ...
                     <td>
                       <a href="{{ route('admin.category.show',$categories->id) }}"><button class="btn btn-sm  text-black"><i class="menu-icon tf-icons bx bx-low-vision"></i></button></a>
                       <a href="{{ route('admin.category.edit',$categories->id) }}"><button class="btn btn-sm  text-black"><i class="menu-icon tf-icons bx bx-edit"></i></button></a>
                       <form action="{{ route('admin.category.destroy',[$categories->id,'page'=>request()->page]) }}" method="post" class="d-inline-block">
                        @csrf
                        @method('delete')
                        <button type="submit" class="btn btn-sm" onclick="return confirm('Are you sure to delete {{$categories->name}}')"><i class="menu-icon tf-icons bx bx-trash"></i></button>
                    </form>
                    </td>
                     </tr>
                     @endforeach
