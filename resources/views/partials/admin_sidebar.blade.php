    ...
    <ul class="menu-inner py-1">
      ...
      <li class="menu-item" id="category">
        <a href="{{ route('admin.category.index') }}" class="menu-link">
          <i class="menu-icon tf-icons bx bx-clothes-circle"></i>
          <div data-i18n="Analytics">Category</div>
        </a>
      </li>


      <li class="menu-item" id="color">
        <a href="{{ route('admin.color.index') }}" class="menu-link">
          <i class="menu-icon tf-icons bx bx-color-circle"></i>
          <div data-i18n="Analytics">Color</div>
        </a>
      </li>

      <li class="menu-item" id="size">
        <a href="{{ route('admin.size.index') }}" class="menu-link">
          <i class="menu-icon tf-icons bx bx-measure-circle"></i>
